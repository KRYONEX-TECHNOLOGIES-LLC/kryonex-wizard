...
const PLAN_TIERS = [
  {
    ...
    description: "For new operations and solo players getting their first consistent lead flow.",
    price: "$249/mo",
    minutes: 300,
    texts: 1000,
    includesFrom: null,
  ...
  },
  {
    ...
    description: "For active businesses scaling up that can't afford a missed booking.",
    price: "$497/mo",
    minutes: 800,
    texts: 3000,
    includesFrom: "PRO",
    ...
    note: "Cheaper than PRO + Top-ups if you're scaling.",
  ...
  },
  {
    ...
    description: "For heavy hitters who never want to worry about limits again.",
    price: "$997/mo",
    minutes: 3000,
    texts: 5000,
    includesFrom: "ELITE",
    ...
    note: "Lowest cost-per-minute for high-volume users.",
