export const TIERS = [
  {
    ...
    whoFor: "For 1–2 tech shops missing daytime calls.",
    accent: "#f59e0b",
    price: "$149/mo",
    minutes: 150,
    sms: 250,
  ...
  },
  {
    ...
    whoFor: "For 1–3 tech teams needing reliable after-hours coverage.",
    accent: "#22d3ee",
    price: "$249/mo",
    minutes: 300,
    sms: 1000,
  ...
  },
  {
    ...
    whoFor: "For 3–8 tech teams that want full 24/7 call automation.",
    accent: "#7c3aed",
    price: "$497/mo",
    minutes: 800,
    sms: 3000,
  ...
  },
  {
    ...
    whoFor: "For 5–20+ tech operations drowning in call volume and ad leads.",
    accent: "#ec4899",
    price: "$997/mo",
    minutes: 3000,
    sms: 5000,
